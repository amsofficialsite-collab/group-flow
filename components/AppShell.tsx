    ...
    <div className="gf-page min-h-screen md:grid md:grid-cols-[260px_1fr]">
      ...
      <main className="min-w-0">
        <header className="gf-header sticky top-0 z-20 flex items-center justify-between border-b px-6 py-5 md:px-8">
          ...
          <div className="flex items-center gap-2"><div className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-500 shadow-sm">V13.3</div><LogoutButton /></div>
        </header>
